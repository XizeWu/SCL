...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, nheads, dim_feedforward=2048, dropout=0.1, activation="relu", **kwargs):
        super().__init__()
    ...
    def forward(self, src,
        ...
        src2, weight = self.self_attn(q, k, value=src, attn_mask=src_mask, key_padding_mask=src_key_padding_mask, output_attentions=True)
